...
def demo(request):
    ...
    for ab in s:
        ...
        c = supply_return_fi.filter(company__company_name =  ab.company.company_name, company_goods__name = ab.company_goods.name, goods_company__goods_company_name = ab.goods_company.goods_company_name, DC_date__gte = date(int(2024), int(3), int(1)), DC_date__lte = date(int(2023), int(5), int(31)))
